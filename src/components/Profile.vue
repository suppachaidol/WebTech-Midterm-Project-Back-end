...
export default {
  data() {
    ...
    methods:{
        async fetchData() {
            await GetHistoriesStore.dispatch("fetchData");
            this.getHistories = GetHistoriesStore.getters.getHistories;

            await HistoriesStore.dispatch("fetchData");
            this.histories = HistoriesStore.getters.histories;
        },
        checkUser(name){
